...
export const ActionNode: React.FC<ActionNodeProps> = ({ id, data }) => {
  ...
  return (
    <div className={`card-premium relative min-w-[280px] max-w-[320px] overflow-hidden group transition-all duration-500 hover:scale-105 hover:shadow-elegant ${
      ...
      <div className="relative bg-gradient-success text-white rounded-t-xl p-6 overflow-hidden">
        ...
        <div className="relative flex items-center space-x-4">
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-2 mb-1">
              <h3 className="font-bold text-sm tracking-wide uppercase opacity-90">ACTION</h3>
              <div className="h-1.5 w-1.5 rounded-full bg-white/60 animate-pulse"></div>
            </div>
            <p className="text-white/90 text-xs font-medium">Processing Step</p>
          </div>
        </div>
      </div>
