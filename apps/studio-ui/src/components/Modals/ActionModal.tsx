        ...
        <div className="bg-gradient-to-r from-green-500 to-teal-600 px-6 py-4 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold">Select an Action</h2>
                <p className="text-green-100">Choose what your workflow does</p>
              </div>
            </div>
            <button 
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-120px)]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {ACTIONS.map((action) => (
              <div
                key={action.id}
                className="group cursor-pointer bg-gradient-to-br from-gray-50 to-gray-100 hover:from-green-50 hover:to-emerald-50 border-2 border-gray-200 hover:border-green-300 rounded-xl p-6 transition-all duration-200 hover:shadow-medium hover:-translate-y-1"
                onClick={() => {
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center text-xs text-gray-500">
                      <span className="bg-gray-200 group-hover:bg-green-200 px-2 py-1 rounded transition-colors">
                        Action
                      </span>
                    </div>
                  </div>
